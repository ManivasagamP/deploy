    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="max-w-6xl mx-auto px-4 py-12 text-black">
                ...
                <p className="text-gray-500 mb-6">Last updated: April 17, 2025</p>
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <h3 className="text-xl font-semibold mt-6 mb-3 text-gray-800">Interpretation</h3>
                    <p className="mb-4">
                    ...
                    <h3 className="text-xl font-semibold mt-6 mb-3 text-gray-800">Definitions</h3>
                    ...
                    <ul className="list-disc pl-6 space-y-3 mb-6">
                        ...
                        <li>
                            <p>
                                ...
                                or &quot;Our&quot; in this Agreement) refers to Fusionpro Solutions Private Limited, 2/413
                                Kathirnaikenpalayam, Vinayagar Kovil Street, Thoppampatti, Coimbatore, Coimbatore North, Tamil Nadu,
                                India, 641017.
                            </p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p>
                                <strong>Website</strong> refers to Fusion Apps, accessible from{" "}
                                <a
                    ...
                    <h4 className="text-lg font-medium mt-5 mb-2 text-gray-700">Personal Data</h4>
                    <p className="mb-4">
                    ...
                    <h4 className="text-lg font-medium mt-5 mb-2 text-gray-700">Usage Data</h4>
                    ...
                    <h4 className="text-lg font-medium mt-5 mb-2 text-gray-700">Tracking Technologies and Cookies</h4>
                    <p className="mb-4">
                    ...
                    <ul className="list-none space-y-6 mb-8">
                        <li className="bg-gray-50 p-4 rounded-lg">
                            <p className="font-semibold mb-2">Necessary / Essential Cookies</p>
                            <p className="text-sm text-gray-600 mb-1">Type: Session Cookies</p>
                            <p className="text-sm text-gray-600 mb-1">Administered by: Us</p>
                            <p className="text-sm">
                        ...
                        <li className="bg-gray-50 p-4 rounded-lg">
                            <p className="font-semibold mb-2">Cookies Policy / Notice Acceptance Cookies</p>
                            <p className="text-sm text-gray-600 mb-1">Type: Persistent Cookies</p>
                            <p className="text-sm text-gray-600 mb-1">Administered by: Us</p>
                            <p className="text-sm">
                        ...
                        <li className="bg-gray-50 p-4 rounded-lg">
                            <p className="font-semibold mb-2">Functionality Cookies</p>
                            <p className="text-sm text-gray-600 mb-1">Type: Persistent Cookies</p>
                            <p className="text-sm text-gray-600 mb-1">Administered by: Us</p>
                            <p className="text-sm">
                    ...
                    <h3 className="text-xl font-semibold mt-8 mb-3 text-gray-800">Use of Your Personal Data</h3>
                    ...
                    <h3 className="text-xl font-semibold mt-8 mb-3 text-gray-800">Retention of Your Personal Data</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-xl font-semibold mt-8 mb-3 text-gray-800">Transfer of Your Personal Data</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-xl font-semibold mt-8 mb-3 text-gray-800">Delete Your Personal Data</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-xl font-semibold mt-8 mb-3 text-gray-800">Disclosure of Your Personal Data</h3>

                    <h4 className="text-lg font-medium mt-5 mb-2 text-gray-700">Business Transactions</h4>
                    <p className="mb-4">
                    ...
                    <h4 className="text-lg font-medium mt-5 mb-2 text-gray-700">Law enforcement</h4>
                    <p className="mb-4">
                    ...
                    <h4 className="text-lg font-medium mt-5 mb-2 text-gray-700">Other legal requirements</h4>
                    <p className="mb-4">
                    ...
                    <h3 className="text-xl font-semibold mt-8 mb-3 text-gray-800">Security of Your Personal Data</h3>
                    <p className="mb-6">
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-4 pb-2 border-b border-gray-200">{`Children's Privacy`}</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-4 pb-2 border-b border-gray-200">Links to Other Websites</h2>
                    <p className="mb-3">
                    ...
                    <h2 className="text-2xl font-bold mt-10 mb-4 pb-2 border-b border-gray-200">Contact Us</h2>
                    ...
                    <ul className="list-none space-y-3 mb-6">
                        ...
                        <li className="flex items-start">
                            <span className="font-medium min-w-28">By website:</span>
                            <a
                                href="https://thefusionapps.com/"
                                rel="noreferrer external nofollow noopener"
                                target="_blank"
                        ...
                        <li className="flex items-start">
                            <span className="font-medium min-w-28">By phone:</span>
                            <span>+91 97915 97993</span>
                        </li>
                        <li className="flex items-start">
                            <span className="font-medium min-w-28">By mail:</span>
                            <span>
                                2/413 Kathirnaikenpalayam, Vinayagar Kovil Street, Thoppampatti, Coimbatore, Coimbatore North, Tamil
                                Nadu, India, 641017
                            </span>
                        </li>
                    </ul>
