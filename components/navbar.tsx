...
export default function Navbar({ activePage }: { activePage?: string }) {
  ...
  > = [
      ...
      { label: "Our Impact", href: "/casestudy", key: "casestudy" },
  ...
  return (
    <nav className="bg-white sticky top-0 z-50 border-b">
            ...
            "dropdown" in item ? (
              <div key={item.key} className="relative group">
                ...
                <div className="absolute left-0 top-5 mt-2 hidden group-hover:block bg-white rounded-xl w-64 py-3 shadow-lg z-50 transition-all duration-300 opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0">
                  {item.key === "products" ? (
                    <>
                      <Link href="/products/engine" className={`block px-4 py-2 text-[14px] hover:bg-gray-100 transition-colors duration-200 ${activePage === "engine" ? "text-[#F28159] font-medium" : "text-[#303030]"}`}>Fusion Engine</Link>
                      ...
                      <Link href="/products/hr" className={`block px-4 py-2 text-[14px] hover:bg-gray-100 transition-colors duration-200 ${activePage === "hr" ? "text-[#F28159] font-medium" : "text-[#303030]"}`}>Fusion HR</Link>
                    </>
                  ) : item.key === "industries" ? (
                    <>
      ...
      >
        ...
        <div className="p-4">
          <Link href="/">
            <div className={`py-4 px-6 mb-2 rounded-lg transition-colors duration-200 hover:bg-gray-50 ${activePage === "home" ? "bg-orange-50 text-[#F28159]" : ""}`}>
          ...
          <div className="mb-2">
            <div 
              className={`py-4 px-6 flex justify-between items-center cursor-pointer transition-colors duration-200 hover:bg-gray-50 rounded-lg ${isProductActive ? "bg-orange-50 text-[#F28159]" : ""}`}
          ...
          <div className="mb-2">
            <div 
              className={`py-4 px-6 flex justify-between items-center cursor-pointer transition-colors duration-200 hover:bg-gray-50 rounded-lg ${isIndustryActive ? "bg-orange-50 text-[#F28159]" : ""}`}
          ...
          <Link href="/about">
            <div className={`py-4 px-6 transition-colors duration-200 hover:bg-gray-50 rounded-lg ${activePage === "about" ? "bg-orange-50 text-[#F28159]" : ""}`}>
              <span className="text-lg font-medium">About Us</span>
            </div>
          </Link>
          
          <Link href="/contact">
            <div className={`py-4 px-6 transition-colors duration-200 hover:bg-gray-50 rounded-lg ${activePage === "contact" ? "bg-orange-50 text-[#F28159]" : ""}`}>
              <span className="text-lg font-medium">Contact Us</span>
            </div>
          </Link>
          <Link href="/casestudy">
            <div className={`py-4 px-6 transition-colors duration-200 hover:bg-gray-50 rounded-lg ${activePage === "contact" ? "bg-orange-50 text-[#F28159]" : ""}`}>
              <span className="text-lg font-medium">Case Study</span>
            </div>
          </Link>
